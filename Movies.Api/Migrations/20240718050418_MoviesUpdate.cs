    ...
    public partial class MoviesUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieTheatersMovies", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesActors_MovieId_ActorId",
                table: "MoviesActors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesGenres_MovieId_GenreId",
                table: "MoviesGenres",
                columns: new[] { "MovieId", "GenreId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MovieTheatersMovies_MovieId_MovieTheaterId",
